...
const long MetrologyPanel::idButtonNewRepair = ::wxNewId();   //New Repair Button
const long MetrologyPanel::idButtonRefreshGrid = ::wxNewId();   //Refresh Button
const long MetrologyPanel::idButtonGetInfo = ::wxNewId();   //Get Button
const long MetrologyPanel::idButtonSearch = ::wxNewId();   //Search Button
const long MetrologyPanel::idButtonUpdateRepair = ::wxNewId();   //Update Repair Button
const long MetrologyPanel::idButtonResetGrid = ::wxNewId();   //Reset Button
const long MetrologyPanel::idButtonSortGrid = ::wxNewId();   //Sort Button

const long MetrologynewRepairDialog::idButtonCreateRepair = ::wxNewId();   //Create Button
const long MetrologynewRepairDialog::idButtonCancelRepair = ::wxNewId();   //Cancel Button
const long MetrologynewRepairDialog::idButtonRepairTemplate = ::wxNewId();   //Cancel Button

const long MetrologyupdateRepairDialog::idButtonDoRepairUpdate = ::wxNewId();   //Create Button
const long MetrologyupdateRepairDialog::idButtonCancelRepairUpdate = ::wxNewId();   //Cancel Button

BEGIN_EVENT_TABLE(MetrologyPanel, wxPanel)

EVT_BUTTON(idButtonNewRepair, MetrologyPanel::onClickNewRepair) //Login Button
EVT_BUTTON(idButtonRefreshGrid, MetrologyPanel::onClickRefresh) //Login Button
EVT_BUTTON(idButtonGetInfo, MetrologyPanel::onClickGet) //New User Button
EVT_BUTTON(idButtonSearch, MetrologyPanel::onClickSearch) //Login Button
EVT_BUTTON(idButtonUpdateRepair, MetrologyPanel::onClickUpdateRepair) //Login Button
EVT_BUTTON(idButtonResetGrid, MetrologyPanel::onClickReset) //Login Button
EVT_BUTTON(idButtonSortGrid, MetrologyPanel::onClickSort) //Login Button

EVT_TIMER(TIMER_ID, MetrologyPanel::OnTimer)

EVT_GRID_CELL_LEFT_CLICK(MetrologyPanel::OnCellLeftClick)
EVT_GRID_CELL_RIGHT_CLICK(MetrologyPanel::OnCellRightClick)
EVT_GRID_CELL_LEFT_DCLICK(MetrologyPanel::OnCellLeftDoubleClick)

END_EVENT_TABLE()



BEGIN_EVENT_TABLE(MetrologynewRepairDialog, wxDialog)

EVT_BUTTON(idButtonCreateRepair, MetrologynewRepairDialog::onClickCreateRepair) //Login Button
EVT_BUTTON(idButtonCancelRepair, MetrologynewRepairDialog::onClickCancelRepair)
EVT_BUTTON(idButtonRepairTemplate, MetrologynewRepairDialog::onClickGetRepairTemplate)

END_EVENT_TABLE()



BEGIN_EVENT_TABLE(MetrologyupdateRepairDialog, wxDialog)

EVT_BUTTON(idButtonDoRepairUpdate, MetrologyupdateRepairDialog::onClickDoRepairUpdate) //Login Button
EVT_BUTTON(idButtonCancelRepairUpdate, MetrologyupdateRepairDialog::onClickCancelRepairUpdate)

END_EVENT_TABLE()


MetrologyBackgroundPanel::MetrologyBackgroundPanel(wxPanel* parent)
    : wxPanel(parent, -1, wxDefaultPosition,
        wxSize(1207, 707))
{

    MGP = new MetrologyPanel(this);

}


MetrologyBackgroundPanel::~MetrologyBackgroundPanel() {}

MetrologyPanel::MetrologyPanel(wxPanel* parent)
    : wxPanel(parent, -1, wxDefaultPosition,
        wxSize(1207, 707))
{
    ///PARENT PANEL
    ...
    contactDataGrid->SetCellBackgroundColour(5, 1, wxColour(220, 240, 255));
...
MetrologyPanel::~MetrologyPanel() {}





void MetrologyPanel::onClickNewRepair(wxCommandEvent& event)
{


    MetrologynewRepairDialog* NRP = new MetrologynewRepairDialog(wxT("New Repair"));
    NRP->Show(true);
}



void MetrologyPanel::REFRESH()
{
    int n = 0;
...
void MetrologyPanel::onClickRefresh(wxCommandEvent& event)
{
    REFRESH();
}


void MetrologyPanel::OnTimer(wxTimerEvent& event)
{
    REFRESH();
}
...
void MetrologyPanel::onClickGet(wxCommandEvent& event)
{
    ...
    else
    {
        ...
        wxSQLite3ResultSet Res8 = db->ExecuteQuery("SELECT DateSent, History FROM nodeData WHERE RepairNumber = '" + logRN + "' AND Source = 'metrology' ORDER BY Chronology DESC LIMIT 5;");
...
void MetrologyPanel::onClickSearch(wxCommandEvent& event)
{
...
void MetrologyPanel::onClickUpdateRepair(wxCommandEvent& event)
{
    ...
    else
    {
        ...
        MetrologyupdateRepairDialog* urdObjPtr = new MetrologyupdateRepairDialog(wxT("Update Repair"));
...
void MetrologyPanel::onClickReset(wxCommandEvent& event)
{
...
void MetrologyPanel::onClickSort(wxCommandEvent& event)
{
    ...
    else if (getSortCriteria == "Date Received") { dbQuery = "SELECT Id, CompanyName, RepairNumber, ModelNumber, Status, DateSent, DateReceived FROM WHERE Status != 'Shipped' nodeData ORDER BY DateReceived ASC;"; }
    else if (getSortCriteria == "Last Updated") { dbQuery = "SELECT Id, CompanyName, RepairNumber, ModelNumber, Status, DateSent, DateReceived FROM WHERE Status != 'Shipped' nodeData ORDER BY DateSent ASC;"; }
...
MetrologynewRepairDialog::MetrologynewRepairDialog(const wxString& title)
...
MetrologynewRepairDialog::~MetrologynewRepairDialog()
{
}
...
void MetrologynewRepairDialog::onClickCreateRepair(wxCommandEvent& event)
{
...
void MetrologynewRepairDialog::onClickCancelRepair(wxCommandEvent& event)
{
    Destroy();
}
...
void MetrologynewRepairDialog::onClickGetRepairTemplate(wxCommandEvent& event)
{
...
MetrologyupdateRepairDialog::MetrologyupdateRepairDialog(const wxString& title)
    : wxDialog(NULL, -1, ("Update Existing Repair"), wxPoint(1100, 500), wxSize(1200, 764))
{
  ...
  //  db->ExecuteQuery("PRAGMA foreign_keys = ON;");
    ...
    wxPanel* panel4 = new wxPanel(parentPanel, -1, wxPoint(600, 283), wxSize(585, 200));
    ...
    updateRepairDataGrid4->SetCellFont(0, 1, wxFont(16, wxSWISS, wxNORMAL, wxNORMAL, false, _("MS Sans Serif")));
...
MetrologyupdateRepairDialog::~MetrologyupdateRepairDialog()
{
}


void MetrologyupdateRepairDialog::onClickDoRepairUpdate(wxCommandEvent& event)
{
...
void MetrologyupdateRepairDialog::onClickCancelRepairUpdate(wxCommandEvent& event)
{
    Destroy();
}


void MetrologyPanel::OnCellRightClick(wxGridEvent& ev)
{
...
void MetrologyPanel::OnCellLeftClick(wxGridEvent& ev)
{
...
void MetrologyPanel::OnCellLeftDoubleClick(wxGridEvent& ev)
{
