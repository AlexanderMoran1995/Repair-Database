...
const long DigitalPanel::idButtonNewRepair = ::wxNewId();   //New Repair Button
const long DigitalPanel::idButtonRefreshGrid = ::wxNewId();   //Refresh Button
const long DigitalPanel::idButtonGetInfo = ::wxNewId();   //Get Button
const long DigitalPanel::idButtonSearch = ::wxNewId();   //Search Button
const long DigitalPanel::idButtonUpdateRepair = ::wxNewId();   //Update Repair Button
const long DigitalPanel::idButtonResetGrid = ::wxNewId();   //Reset Button
const long DigitalPanel::idButtonSortGrid = ::wxNewId();   //Sort Button

const long DigitalnewRepairDialog::idButtonCreateRepair = ::wxNewId();   //Create Button
const long DigitalnewRepairDialog::idButtonCancelRepair = ::wxNewId();   //Cancel Button
const long DigitalnewRepairDialog::idButtonRepairTemplate = ::wxNewId();   //Cancel Button

const long DigitalupdateRepairDialog::idButtonDoRepairUpdate = ::wxNewId();   //Create Button
const long DigitalupdateRepairDialog::idButtonCancelRepairUpdate = ::wxNewId();   //Cancel Button
const long DigitalupdateRepairDialog::idButtonAddNote = ::wxNewId();   //Cancel Button


BEGIN_EVENT_TABLE(DigitalPanel, wxPanel)

EVT_BUTTON(idButtonNewRepair, DigitalPanel::onClickNewRepair) //Login Button
EVT_BUTTON(idButtonRefreshGrid, DigitalPanel::onClickRefresh) //Login Button
EVT_BUTTON(idButtonGetInfo, DigitalPanel::onClickGet) //New User Button
EVT_BUTTON(idButtonSearch, DigitalPanel::onClickSearch) //Login Button
EVT_BUTTON(idButtonUpdateRepair, DigitalPanel::onClickUpdateRepair) //Login Button
EVT_BUTTON(idButtonResetGrid, DigitalPanel::onClickReset) //Login Button
EVT_BUTTON(idButtonSortGrid, DigitalPanel::onClickSort) //Login Button

EVT_TIMER(TIMER_ID, DigitalPanel::OnTimer)

EVT_GRID_CELL_LEFT_CLICK(DigitalPanel::OnCellLeftClick)
EVT_GRID_CELL_RIGHT_CLICK(DigitalPanel::OnCellRightClick)
EVT_GRID_CELL_LEFT_DCLICK(DigitalPanel::OnCellLeftDoubleClick)

END_EVENT_TABLE()



BEGIN_EVENT_TABLE(DigitalnewRepairDialog, wxDialog)

EVT_BUTTON(idButtonCreateRepair, DigitalnewRepairDialog::onClickCreateRepair) //Login Button
EVT_BUTTON(idButtonCancelRepair, DigitalnewRepairDialog::onClickCancelRepair)
EVT_BUTTON(idButtonRepairTemplate, DigitalnewRepairDialog::onClickGetRepairTemplate)

END_EVENT_TABLE()



BEGIN_EVENT_TABLE(DigitalupdateRepairDialog, wxDialog)

EVT_BUTTON(idButtonDoRepairUpdate, DigitalupdateRepairDialog::onClickDoRepairUpdate) //Login Button
EVT_BUTTON(idButtonCancelRepairUpdate, DigitalupdateRepairDialog::onClickCancelRepairUpdate)
EVT_BUTTON(idButtonAddNote, DigitalupdateRepairDialog::onClickAddNote)

END_EVENT_TABLE()


DigitalBackgroundPanel::DigitalBackgroundPanel(wxPanel* parent)
    : wxPanel(parent, -1, wxDefaultPosition,
        wxSize(1207, 707))
{

    DGP = new DigitalPanel(this);

}


DigitalBackgroundPanel::~DigitalBackgroundPanel() {}

DigitalPanel::DigitalPanel(wxPanel* parent)
    : wxPanel(parent, -1, wxDefaultPosition,
        wxSize(1207, 707))
{
    ///PARENT PANEL
    ...
    wxPanel* formTitlePanel = new wxPanel(formPanel, wxID_ANY,
        wxPoint(-1, -1), wxSize(244, 28), wxBORDER_NONE);
   ...
   formTitle->SetFont(wxFont(16, wxSWISS, wxNORMAL, wxNORMAL, false, _("MS Sans Serif")));
    ...
    static const int INTERVAL = 90000; // milliseconds
...
void DigitalPanel::onClickNewRepair(wxCommandEvent& event)
{
    DigitalnewRepairDialog* NRP = new DigitalnewRepairDialog(wxT("New Repair"));
    NRP->Show(true);
}
...
void DigitalPanel::onClickRefresh(wxCommandEvent& event)
{
    REFRESH();
}


void DigitalPanel::OnTimer(wxTimerEvent& event)
{
    REFRESH();
}
...
void DigitalPanel::onClickGet(wxCommandEvent& event)
{
    ...
    else
    {
        ...
        wxSQLite3ResultSet Res8 = db->ExecuteQuery("SELECT DateSent, History FROM nodeData WHERE RepairNumber = '" + logRN + "' AND Source = 'digital' ORDER BY Chronology DESC LIMIT 5;");
...
void DigitalPanel::onClickSearch(wxCommandEvent& event)
{
...
void DigitalPanel::onClickUpdateRepair(wxCommandEvent& event)
{
    ...
    else
    {
        ...
        DigitalupdateRepairDialog* urdObjPtr = new DigitalupdateRepairDialog(wxT("Update Repair"));
...
void DigitalPanel::onClickReset(wxCommandEvent& event)
{
...
void DigitalPanel::onClickSort(wxCommandEvent& event)
{
    ...
    else if (getSortCriteria == "Model #") { dbQuery = "SELECT Id, CompanyName, RepairNumber, ModelNumber, Status, DateSent, DateReceived FROM nodeData WHERE Status != 'Shipped' ORDER BY ModelNumber ASC;"; }
...
DigitalnewRepairDialog::DigitalnewRepairDialog(const wxString& title)
...
DigitalnewRepairDialog::~DigitalnewRepairDialog()
{
}
...
void DigitalnewRepairDialog::onClickCreateRepair(wxCommandEvent& event)
{
    const int MAXLEN = 80;
    char s[MAXLEN];
    time_t t = time(0);
...
void DigitalnewRepairDialog::onClickCancelRepair(wxCommandEvent& event)
{
    Destroy();
}
...
void DigitalnewRepairDialog::onClickGetRepairTemplate(wxCommandEvent& event)
{
...
DigitalupdateRepairDialog::DigitalupdateRepairDialog(const wxString& title)
    : wxDialog(NULL, -1, ("Update Existing Repair"), wxPoint(1100, 500), wxSize(1200, 764))
{
  ...
  //  updateRepairDataGrid->SetCellEditor(17, 1, new wxGridCellChoiceEditor(WXSIZEOF(caseChoices), caseChoices));
   ...
   //  updateRepairDataGrid2->SetCellAlignment(6, 1, wxALIGN_CENTRE, wxALIGN_CENTRE);
     ...
     const wxString RepairLevels[] =
     {
         "D01 Repair Level 1 - Clean & calibrate, no board work",
         "D02 Repair Level 2 - Replace multiple components",
         "D03 Repair Level 3 - Board replaced",
         "D04 Replace Chasis (BPD & PD only)",
         "D05 Replace case",
         "D06 Convert PDV from  C to F or from F to C",
         "D07 Repair time 20 minutes or more to be quoted",
         "Other",
   ...
   //   updateRepairDataGrid2->SetCellEditor(5, 1, new wxGridCellChoiceEditor(WXSIZEOF(statusChoices), statusChoices));
     ...
     // db->ExecuteQuery("PRAGMA foreign_keys = ON;");
      ...
      wxPanel* panel3 = new wxPanel(parentPanel, -1, wxPoint(600, 40), wxSize(585, 200));
      ...
      updateRepairDataGrid3->SetDefaultRowSize(195);
      updateRepairDataGrid3->SetCellAlignment(0, 0, wxALIGN_LEFT, wxALIGN_CENTER);
...
/// REPAIR DROPDOWN \\\
      ...
      wxPanel* panel6 = new wxPanel(parentPanel, -1, wxPoint(600, 259), wxSize(493, 40));
      ...
      updateRepairDataGrid6->SetCellEditor(0, 0, new wxGridCellChoiceEditor(WXSIZEOF(RepairLevels), RepairLevels));

      wxBitmapButton* CreateAddbutton = new wxBitmapButton(parentPanel, idButtonAddNote, wxBitmap(wxT("add.png"),
          wxBITMAP_TYPE_PNG), wxPoint(1097, 255), wxSize(-1, -1), wxSIMPLE_BORDER);
...
/// WHAT WE FOUND \\\
      ...
      wxPanel* panel4 = new wxPanel(parentPanel, -1, wxPoint(600, 307), wxSize(585, 200));
      ...
      updateRepairDataGrid4->SetDefaultRowSize(195);
      ...
      updateRepairDataGrid4->SetCellFont(0,1,wxFont(12, wxSWISS, wxBOLD, wxBOLD, false, _("MS Sans Serif")));
      ...
      wxPanel* panel5 = new wxPanel(parentPanel, -1, wxPoint(600, 525), wxSize(585, 200));
      ...
      updateRepairDataGrid5->SetDefaultRowSize(195);
...
DigitalupdateRepairDialog::~DigitalupdateRepairDialog()
{
}
...
void DigitalupdateRepairDialog::onClickDoRepairUpdate(wxCommandEvent& event)
{
...
void DigitalupdateRepairDialog::onClickCancelRepairUpdate(wxCommandEvent& event)
{
    Destroy();
}


void DigitalupdateRepairDialog::onClickAddNote(wxCommandEvent& event)
{
...
void DigitalPanel::OnCellRightClick(wxGridEvent& ev)
{
...
void DigitalPanel::OnCellLeftClick(wxGridEvent& ev)
{
...
void DigitalPanel::OnCellLeftDoubleClick(wxGridEvent& ev)
{
