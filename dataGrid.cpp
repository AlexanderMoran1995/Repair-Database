...
const long AnalogPanel::idButtonNewRepair = ::wxNewId();   //New Repair Button
const long AnalogPanel::idButtonRefreshGrid = ::wxNewId();   //Refresh Button
const long AnalogPanel::idButtonGetInfo = ::wxNewId();   //Get Button
const long AnalogPanel::idButtonSearch = ::wxNewId();   //Search Button
const long AnalogPanel::idButtonUpdateRepair = ::wxNewId();   //Update Repair Button
const long AnalogPanel::idButtonResetGrid = ::wxNewId();   //Reset Button
const long AnalogPanel::idButtonSortGrid = ::wxNewId();   //Sort Button

const long AnalognewRepairDialog::idButtonCreateRepair = ::wxNewId();   //Create Button
const long AnalognewRepairDialog::idButtonCancelRepair = ::wxNewId();   //Cancel Button
const long AnalognewRepairDialog::idButtonRepairTemplate = ::wxNewId();   //Cancel Button

const long AnalogupdateRepairDialog::idButtonDoRepairUpdate = ::wxNewId();   //Create Button
const long AnalogupdateRepairDialog::idButtonCancelRepairUpdate = ::wxNewId();   //Cancel Button
const long AnalogupdateRepairDialog::idButtonAddNote = ::wxNewId();   //Cancel Button


BEGIN_EVENT_TABLE(AnalogPanel, wxPanel)

EVT_BUTTON(idButtonNewRepair, AnalogPanel::onClickNewRepair) //Login Button
EVT_BUTTON(idButtonRefreshGrid, AnalogPanel::onClickRefresh) //Login Button
EVT_BUTTON(idButtonGetInfo, AnalogPanel::onClickGet) //New User Button
EVT_BUTTON(idButtonSearch, AnalogPanel::onClickSearch) //Login Button
EVT_BUTTON(idButtonUpdateRepair, AnalogPanel::onClickUpdateRepair) //Login Button
EVT_BUTTON(idButtonResetGrid, AnalogPanel::onClickReset) //Login Button
EVT_BUTTON(idButtonSortGrid, AnalogPanel::onClickSort) //Login Button

EVT_TIMER(TIMER_ID, AnalogPanel::OnTimer)

EVT_GRID_CELL_LEFT_CLICK(AnalogPanel::OnCellLeftClick)
EVT_GRID_CELL_RIGHT_CLICK(AnalogPanel::OnCellRightClick)
EVT_GRID_CELL_LEFT_DCLICK(AnalogPanel::OnCellLeftDoubleClick)

END_EVENT_TABLE()



BEGIN_EVENT_TABLE(AnalognewRepairDialog, wxDialog)

EVT_BUTTON(idButtonCreateRepair, AnalognewRepairDialog::onClickCreateRepair) //Login Button
EVT_BUTTON(idButtonCancelRepair, AnalognewRepairDialog::onClickCancelRepair)
EVT_BUTTON(idButtonRepairTemplate, AnalognewRepairDialog::onClickGetRepairTemplate)

END_EVENT_TABLE()



BEGIN_EVENT_TABLE(AnalogupdateRepairDialog, wxDialog)

EVT_BUTTON(idButtonDoRepairUpdate, AnalogupdateRepairDialog::onClickDoRepairUpdate) //Login Button
EVT_BUTTON(idButtonCancelRepairUpdate, AnalogupdateRepairDialog::onClickCancelRepairUpdate)
EVT_BUTTON(idButtonAddNote, AnalogupdateRepairDialog::onClickAddNote)

END_EVENT_TABLE()


AnalogBackgroundPanel::AnalogBackgroundPanel(wxPanel* parent)
    : wxPanel(parent, -1, wxDefaultPosition,
        wxSize(1207, 707))
{

    AGP = new AnalogPanel(this);

}


AnalogBackgroundPanel::~AnalogBackgroundPanel() {}

AnalogPanel::AnalogPanel(wxPanel* parent)
    : wxPanel(parent, -1, wxDefaultPosition,
        wxSize(1207, 707))
{
    ///PARENT PANEL
...
AnalogPanel::~AnalogPanel() {}





void AnalogPanel::onClickNewRepair(wxCommandEvent& event)
{


    AnalognewRepairDialog* NRP = new AnalognewRepairDialog(wxT("New Repair"));
    NRP->Show(true);
}


void AnalogPanel::REFRESH()
{
    int n = 0;
...
void AnalogPanel::onClickRefresh(wxCommandEvent& event)
{
    REFRESH();
}


void AnalogPanel::OnTimer(wxTimerEvent& event) 
{
    REFRESH();
}


void AnalogPanel::onClickGet(wxCommandEvent& event)
{
    ...
    else
    {
        ...
        wxSQLite3ResultSet Res8 = db->ExecuteQuery("SELECT DateSent, History FROM nodeData WHERE RepairNumber = '" + logRN + "' AND Source = 'analog' ORDER BY Chronology DESC LIMIT 5;");
...
void AnalogPanel::onClickSearch(wxCommandEvent& event)
{
...
void AnalogPanel::onClickUpdateRepair(wxCommandEvent& event)
{
    wxString tempUpdate = updateEntry->GetValue();
    //wxString tempUpdate = '1';
    ...
    else
    {
        ...
        AnalogupdateRepairDialog* urdObjPtr = new AnalogupdateRepairDialog(wxT("Update Repair"));
...
void AnalogPanel::onClickReset(wxCommandEvent& event)
{
...
void AnalogPanel::onClickSort(wxCommandEvent& event)
{
...
AnalognewRepairDialog::AnalognewRepairDialog(const wxString& title)
...
AnalognewRepairDialog::~AnalognewRepairDialog()
{
}
...
void AnalognewRepairDialog::onClickCreateRepair(wxCommandEvent& event)
{
    const int MAXLEN = 80;
    char s[MAXLEN];
    time_t t = time(0);
...
void AnalognewRepairDialog::onClickCancelRepair(wxCommandEvent& event)
{
    Destroy();
}
...
void AnalognewRepairDialog::onClickGetRepairTemplate(wxCommandEvent& event)
{
...
AnalogupdateRepairDialog::AnalogupdateRepairDialog(const wxString& title)
    : wxDialog(NULL, -1, ("Update Existing Repair"), wxPoint(1100, 500), wxSize(1200, 764))
{
  ...
  //  updateRepairDataGrid2->SetCellAlignment(6, 1, wxALIGN_CENTRE, wxALIGN_CENTRE);
    ...
    {
        "A01 Repair Level 1 - Basic repair - clean & calibrate",
        "A02 Repair Level 2 - Basic repair + replace components",
        "A03 Repair Level 3 - Basic repair + replace meter",
        "A04 Repair Level 4 - General check of instrument",
        "A05 Replace chassis",
        "A06 New Case (black molded case for NMP)",
        "Other",
...
AnalogupdateRepairDialog::~AnalogupdateRepairDialog()
{
}
...
void AnalogupdateRepairDialog::onClickDoRepairUpdate(wxCommandEvent& event)
{
...
void AnalogupdateRepairDialog::onClickCancelRepairUpdate(wxCommandEvent& event)
{
    Destroy();
}


void AnalogupdateRepairDialog::onClickAddNote(wxCommandEvent& event)
{
...
void AnalogPanel::OnCellRightClick(wxGridEvent& ev)
{
...
void AnalogPanel::OnCellLeftClick(wxGridEvent& ev)
{
...
void AnalogPanel::OnCellLeftDoubleClick(wxGridEvent& ev)
{
