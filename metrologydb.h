#ifndef METROLOGYDB_H_INCLUDED
#define METROLOGYDB_H_INCLUDED
...
class MetrologyPanel : public wxPanel
{
    wxGrid* grid;
...
class MetrologynewRepairDialog : public wxDialog
{
public:
    MetrologynewRepairDialog(const wxString& title);
    ~MetrologynewRepairDialog();
...
class MetrologyupdateRepairDialog : public wxDialog
{
...
public:
    MetrologyupdateRepairDialog(const wxString& title);
    ~MetrologyupdateRepairDialog();
...
class MetrologyBackgroundPanel : public wxPanel
{


public:
    MetrologyBackgroundPanel(wxPanel* parent);
    ~MetrologyBackgroundPanel();

    MetrologyPanel* MGP;
    MetrologynewRepairDialog* NRPD;
    MetrologyupdateRepairDialog* URD;
