...
const long MiscPanel::idButtonNewRepair = ::wxNewId();   //New Repair Button
const long MiscPanel::idButtonRefreshGrid = ::wxNewId();   //Refresh Button
const long MiscPanel::idButtonGetInfo = ::wxNewId();   //Get Button
const long MiscPanel::idButtonSearch = ::wxNewId();   //Search Button
const long MiscPanel::idButtonUpdateRepair = ::wxNewId();   //Update Repair Button
const long MiscPanel::idButtonResetGrid = ::wxNewId();   //Reset Button
const long MiscPanel::idButtonSortGrid = ::wxNewId();   //Sort Button

const long MiscnewRepairDialog::idButtonCreateRepair = ::wxNewId();   //Create Button
const long MiscnewRepairDialog::idButtonCancelRepair = ::wxNewId();   //Cancel Button
const long MiscnewRepairDialog::idButtonRepairTemplate = ::wxNewId();   //Cancel Button

const long MiscupdateRepairDialog::idButtonDoRepairUpdate = ::wxNewId();   //Create Button
const long MiscupdateRepairDialog::idButtonCancelRepairUpdate = ::wxNewId();   //Cancel Button





BEGIN_EVENT_TABLE(MiscPanel, wxPanel)

EVT_BUTTON(idButtonNewRepair, MiscPanel::onClickNewRepair) //Login Button
EVT_BUTTON(idButtonRefreshGrid, MiscPanel::onClickRefresh) //Login Button
EVT_BUTTON(idButtonGetInfo, MiscPanel::onClickGet) //New User Button
EVT_BUTTON(idButtonSearch, MiscPanel::onClickSearch) //Login Button
EVT_BUTTON(idButtonUpdateRepair, MiscPanel::onClickUpdateRepair) //Login Button
EVT_BUTTON(idButtonResetGrid, MiscPanel::onClickReset) //Login Button
EVT_BUTTON(idButtonSortGrid, MiscPanel::onClickSort) //Login Button

EVT_TIMER(TIMER_ID, MiscPanel::OnTimer)

EVT_GRID_CELL_LEFT_CLICK(MiscPanel::OnCellLeftClick)
EVT_GRID_CELL_RIGHT_CLICK(MiscPanel::OnCellRightClick)
EVT_GRID_CELL_LEFT_DCLICK(MiscPanel::OnCellLeftDoubleClick)

END_EVENT_TABLE()



BEGIN_EVENT_TABLE(MiscnewRepairDialog, wxDialog)

EVT_BUTTON(idButtonCreateRepair, MiscnewRepairDialog::onClickCreateRepair) //Login Button
EVT_BUTTON(idButtonCancelRepair, MiscnewRepairDialog::onClickCancelRepair)
EVT_BUTTON(idButtonRepairTemplate, MiscnewRepairDialog::onClickGetRepairTemplate)

END_EVENT_TABLE()



BEGIN_EVENT_TABLE(MiscupdateRepairDialog, wxDialog)

EVT_BUTTON(idButtonDoRepairUpdate, MiscupdateRepairDialog::onClickDoRepairUpdate) //Login Button
EVT_BUTTON(idButtonCancelRepairUpdate, MiscupdateRepairDialog::onClickCancelRepairUpdate)
...
MiscBackgroundPanel::MiscBackgroundPanel(wxPanel* parent)
    : wxPanel(parent, -1, wxDefaultPosition,
        wxSize(1207, 707))
{

    MiscGP = new MiscPanel(this);

}


MiscBackgroundPanel::~MiscBackgroundPanel() {}

MiscPanel::MiscPanel(wxPanel* parent)
    : wxPanel(parent, -1, wxDefaultPosition,
        wxSize(1207, 707))
{
    ///PARENT PANEL
    ...
    static const int INTERVAL = 10000; // milliseconds
...
void MiscPanel::onClickNewRepair(wxCommandEvent& event)
{
    MiscnewRepairDialog* NRP = new MiscnewRepairDialog(wxT("New Repair"));
    NRP->Show(true);
}



void MiscPanel::REFRESH()
{
    int n = 0;
...
void MiscPanel::onClickRefresh(wxCommandEvent& event)
{
    REFRESH();
}


void MiscPanel::OnTimer(wxTimerEvent& event)
{
    REFRESH();
}


void MiscPanel::onClickGet(wxCommandEvent& event)
{
    ...
    else
    {
        ...
        wxSQLite3ResultSet Res8 = db->ExecuteQuery("SELECT DateSent, History FROM nodeData WHERE RepairNumber = '" + logRN + "' AND Source = 'misc' ORDER BY Chronology DESC LIMIT 5;");
...
void MiscPanel::onClickSearch(wxCommandEvent& event)
{
...
void MiscPanel::onClickUpdateRepair(wxCommandEvent& event)
{
    ...
    else
    {
        ...
        MiscupdateRepairDialog* urdObjPtr = new MiscupdateRepairDialog(wxT("Update Repair"));
...
void MiscPanel::onClickReset(wxCommandEvent& event)
{
...
void MiscPanel::onClickSort(wxCommandEvent& event)
{
...
MiscnewRepairDialog::MiscnewRepairDialog(const wxString& title)
...
MiscnewRepairDialog::~MiscnewRepairDialog()
{
}
...
void MiscnewRepairDialog::onClickCreateRepair(wxCommandEvent& event)
{
...
void MiscnewRepairDialog::onClickCancelRepair(wxCommandEvent& event)
{
    Destroy();
}
...
void MiscnewRepairDialog::onClickGetRepairTemplate(wxCommandEvent& event)
{
...
MiscupdateRepairDialog::MiscupdateRepairDialog(const wxString& title)
...
MiscupdateRepairDialog::~MiscupdateRepairDialog()
{
}



void MiscupdateRepairDialog::onClickDoRepairUpdate(wxCommandEvent& event)
{
...
void MiscupdateRepairDialog::onClickCancelRepairUpdate(wxCommandEvent& event)
{
    Destroy();
}
...
void MiscPanel::OnCellRightClick(wxGridEvent& ev)
{
...
void MiscPanel::OnCellLeftClick(wxGridEvent& ev)
{
...
void MiscPanel::OnCellLeftDoubleClick(wxGridEvent& ev)
{
